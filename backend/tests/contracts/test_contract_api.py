...
def contracts_url(family):
    return reverse("contracts:family-contracts", args=[family.id])


def contract_url(family, contract):
    return reverse("contracts:family-contract", args=[family.id, contract.id])
...
def attach_family_url(family, contract):
    return reverse("contracts:contract-attach-family", args=[family.id, contract.id])
